    ...
    id='About'>
        ...
        <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
            ...
            <div className='flex flex-col items-center md:items-start mt-10 text-grey-600'>
                ...
                "Welcome to Estate - your trusted partner in finding dream homes, 
                investment properties, and commercial spaces. Explore a wide range 
                of listings tailored to your needs, backed by expert guidance and 
                seamless service. Start your journey with us today!"
